...
```bash
git clone https://github.com/jvlzloons/design_portfolio.git
cd design_portfolio
```
...
Then run the schema and seed SQL found in the project setup docs.
...
DATABASE_URL=postgresql://postgres:your_password@localhost:5432/portfolio?sslmode=disable
```
...
Branding · Print · UI/UX · Typography · Packaging · Motion Graphics · Illustration

## Built By

**Josh Villaluz** — designer who codes, developer who designs.

---

<p align="center">
  <sub>Designed and developed from scratch. No templates. No shortcuts.</sub>
</p>